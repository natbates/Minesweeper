...
class Board():
    ...
    def _DisplayClock(self):
        ...
        self._miliseconds += 1 # Increments Miliseconds Each time the clocks Ticks (100/s)

        if self._miliseconds == 10: # 10 Miliseconds in a Second

            self._secs += 1
            self._miliseconds = 0 # Resets
...
class Tile(Button):
        ...
        def _DisplayFlags(self):
            ...
            if self._FlagOn == True:
                ...
                GameScreen.blit(FlagImg, (self._x, self._y))
        ...
        def _DisplayTiles(self):
            ...
            if self._TileOn == True:
                ...
                GameScreen.blit(self._image, (self._x, self._y))
...
def RemoveTiles(AllTiles):
    ...
    for i in range(len(AllTiles)):
        ...
        if AllTiles[i]._checkForClick() == True: # Checks What Remaining On Tiles Collides with Mouse Position using Button Method checkForClick
            ...
            if FlagLock == True and AllTiles[i]._FlagOn == False:
...
while MainGameLoop:
    ...
    while MainMenuLoop:
        ...
        SoundOnButton._Draw(MenuScreen)
        SaveScoreButton._Draw(MenuScreen)
        PlayButton._Draw(MenuScreen)
        QuitButton._Draw(MenuScreen)


        if PlayButton._checkForClick() == True:

            MainMenuLoop = False

        if QuitButton._checkForClick() == True:

            pygame.quit()
            sys.exit()

        if BeginnerButton._checkForClick() == True:
        ...
        if IntermediateButton._checkForClick() == True:
        ...
        if ExpertButton._checkForClick() == True:
        ...
        if CustomButton._checkForClick() == True:
        ...
        if SaveScoreButton._checkForClick() == True:
        ...
        if TileLockOnButton._checkForClick() == True:
        ...
        if SoundOnButton._checkForClick() == True:
