...
class Board():
    ...
    def __init__(self, boardSize, Difficulty, Mines):
        ...
        self.Flags = []
        self.MaxScore = boardSize[1] * boardSize[0] * Mines
        ...
        self.ScoreConstant = (self.Mines / (self.boardSize[0] * self.boardSize[1])) * 100
    ...
    def DisplayAmountOfFlagsandBombs(self):
        ...
        GameScreen.blit(MineNum, (35, 25))

        GameScreen.blit(FlagImg, (15, 15))
        GameScreen.blit(BombMenuImg, (50, 17))

    def CalculateScore(self):

        # FInd Area/Mine Ratio and Divide By Time Taken

        self.Score = self.Score + self.ScorePerTile

        # Round Score up

        self.Score = math.trunc(self.Score) # Gets Rid of Decimal Places
    ...
    def DisplayScore(self):
        ...
        GameScreen.blit(score, (ScreenWidth - 35, 25))
